...
const WelcomeMessage: React.FC<WelcomeMessageProps> = ({ isRecording, error }) => {
  ...
  if (!isRecording) {
    return (
      ...
      <div className="w-full max-w-md p-6 sm:p-8 rounded-xl bg-gray-800/90 backdrop-blur-sm shadow-2xl text-center">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-white">Voice-Controlled Drawing</h1>
        ...
        <div className="text-white/90 space-y-2 text-left border-t border-white/20 pt-4 mt-4">
          <p className="font-semibold mb-2 text-sm sm:text-base">Tips for generating different frequencies:</p>
